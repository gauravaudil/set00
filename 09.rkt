...
There is a difference between remainder and modulo.
suppose mod() calculates modulo and rem() calculates remainder,
The functions we can define as:
rem(a, b) (- a (* b (/ a b))) 
mod(a, b) (rem((+ b (rem( a, b ))), b)) 